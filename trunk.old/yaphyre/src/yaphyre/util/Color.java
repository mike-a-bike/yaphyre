 ...
 * of {@link Color} is immutable. Some simple operations are provided as for example adding two color, multiplying
...
public class Color implements Serializable {
	...
	/**
	 * Compares two instances. If the instance to compare to is a {@link Color}, non-null and each its three color
	 * components has the same value as this instance, the two {@link Color}s are equal.
	 *
	 * @return <code>true</code> if both {@link Color} instances represent the same red, green and blue values.
	 */
	@Override
	 ...
	 *
	 * @return A new instance of {@link Color} with each component value between zero and one.
	 */
	public Color clip() {
