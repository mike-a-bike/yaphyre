...
/**
 * Bounding boxes are used to speed up the rendering process. Complex {@link yaphyre.core.api.Shape}s are wrapped by such a {@link
 ...
 * also intersects with the wrapped {@link yaphyre.core.api.Shape}.
 *
