...
public class Transformation implements Serializable {
	 ...
	 *
	 * @param matrix The {@link yaphyre.core.math.Matrix} this transformation is based upon.
	 */
	 ...
	 *
	 * @param matrix  The {@link yaphyre.core.math.Matrix} this transformation uses.
	 * @param inverse The {@link yaphyre.core.math.Matrix} used for its inverse.
	 */
	...
	/**
	 * Factory method for creating a {@link yaphyre.core.math.Transformation} for the given translation.
	 *
	 * @param x The x component of the translation
	 * @param y The y component of the translation
	 * @param z The z component of the translation
	 *
	 * @return A {@link yaphyre.core.math.Transformation} with the translation matrix and its inverse.
	 */
	...
	/**
	 * Factory method for creating a scaling {@link yaphyre.core.math.Transformation}. The scaling factors for each direction can be
	 * different.
	 *
	 ...
	 *
	 * @return A {@link yaphyre.core.math.Transformation} with the scaling matrix and its inverse.
	 */
	 ...
	 *
	 * @return A {@link yaphyre.core.math.Transformation} with the rotation matrix.
	 */
	...
	/**
	 * {@link yaphyre.core.math.Transformation} which rotates a certain angle around an arbitrary axis defined by the given {@link
	 * yaphyre.core.math.Vector3D}.
	 *
	...
	/**
	 * 'Look at' {@link yaphyre.core.math.Transformation}. This describes the {@link yaphyre.core.math.Transformation} necessary to map coordinates when a
	 * location is given and a point to 'look at'. In order to define the correct {@link yaphyre.core.math.Transformation}, an 'up' {@link
	 * yaphyre.core.math.Vector3D} is needed based on which the new coordinate system is built. The up vector is recalculated during the
	 * transformation.
	 *
	 * @param eye    The location of the eye ({@link yaphyre.core.math.Point3D})
	 * @param lookAt The point to look at ({@link yaphyre.core.math.Point3D})
	 * @param up     An imaginary up vector to make rotations of the coordinate system possible ({@link yaphyre.core.math.Vector3D})
	 *
	 * @return A {@link yaphyre.core.math.Transformation} which aligns the given coordinates with the aligned coordinate system.
	 *
	 ...
	 *
	 * @return A {@link yaphyre.core.math.Transformation} containing the view transformation.
	 */
	 ...
	 *
	 * @return A {@link yaphyre.core.math.Transformation} which maps the raster coordinates onto a unit square.
	 */
	...
	/**
	 * Calculate the inverse {@link yaphyre.core.math.Transformation} for this {@link yaphyre.core.math.Transformation}.
	 *
	...
	/**
	 * Calculate the transposed {@link yaphyre.core.math.Transformation} for this instance.
	 *
	...
	/**
	 * Multiply two Transformations. Use this to 'chain' multiple {@link yaphyre.core.math.Transformation}s into one single operation.
	 *
	 * @param trans The instance to multiply this instance with.
	 *
	 * @return A new {@link yaphyre.core.math.Transformation} containing both operations within one instance.
	 */
	...
	/**
	 * Transform a {@link yaphyre.core.math.Point3D} using the operation stored within this instance. Points are scaled, rotated and
	 * translated.
	 *
	 * @param p The {@link yaphyre.core.math.Point3D} to transform.
	 *
	...
	/**
	 * Transform a {@link yaphyre.core.math.Point2D} using the operation within this transformation instance. Points are scaled, rotated and
	 * translated.
	 *
	 * @param p The {@link yaphyre.core.math.Point2D} to transform.
	 *
	 * @return A transformed {@link yaphyre.core.math.Point2D} instance.
	 */
	...
	/**
	 * Transform a {@link yaphyre.core.math.Vector3D} using the operation of this transformation instance. Vectors are scaled and rotated.
	 * Since a mathematical vector has no defined origin, a vector is not translated.
	 *
	 * @param v The {@link yaphyre.core.math.Vector3D} to transform.
	 *
	 * @return A new, transformed {@link yaphyre.core.math.Vector3D} instance.
	 */
	...
	/**
	 * Transforms a {@link yaphyre.core.math.Normal3D}. Normals are very special. In order to maintain their properties (like being
	 ...
	 *
	 * @param n The {@link yaphyre.core.math.Normal3D} to transform.
	 *
	 * @return The transformed {@link yaphyre.core.math.Normal3D} instance.
	 *
	...
	/**
	 * This transforms a {@link yaphyre.core.math.Ray} instance. To do this, the point of origin for the ray ({@link yaphyre.core.math.Ray#getOrigin()}) is
	 * transformed as a {@link yaphyre.core.math.Point3D} and its direction ({@link yaphyre.core.math.Ray#getDirection()}) is transformed as a vector. Please
	 * notice, the length of the direction vector is not necessarily one after the transformation.
	 *
	 * @param r The {@link yaphyre.core.math.Ray} to transform.
	 *
