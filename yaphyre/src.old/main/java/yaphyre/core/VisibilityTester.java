...
public class VisibilityTester {
	...
	public VisibilityTester(final Point3D p1, final Point3D p2) {
	...
	public VisibilityTester(final Point3D p, final Vector3D w) {
		ray = new Ray(p, w.normalize());
	}

	public boolean isUnobstructed(Scene scene) {
		return scene.getCollisionInformation(ray, ray.getMaxt()) == null;
	}
