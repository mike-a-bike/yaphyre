...
public interface Sampler {
	...
	/**
	 * Gets a list of {@link Point2D} within a unit square. u = (0, 1) and v = (0, 1).
	 *
	...
	/**
	 * Gets a list of samples which all lie within a unit circle. A circle with radius 1 and origin at [0, 0].
	 *
	 * @return An {@link Iterable} usable in loop to access all the samples.
	 */
	...
	/**
	 * Create a list of samples each lies on a unit sphere, which is a sphere with the radius 1 and the origin = [0, 0].
	 * This method is used mostly for the creation of samples used to render spherical light sources.
	 *
	 * @return An {@link Iterable} usable in loop to access all the samples.
	 */
