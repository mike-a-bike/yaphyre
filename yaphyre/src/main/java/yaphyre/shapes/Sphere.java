...
import static yaphyre.math.MathUtils.isInRangeWithTolerance;
...
public class Sphere extends AbstractShape {
	 ...
	 *
	 * @return A new instance of {@link yaphyre.shapes.Sphere}.
	 *
	...
	/**
	 * Calculate the normal for the given point. For a {@link yaphyre.shapes.Sphere} this is pretty simple: <ol> <li>Transform the
